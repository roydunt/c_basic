 ...
 *  (int num = 4; > num)
 *  - 포인터 사용 > 추가적으로 변수선언, 주소연산, 간접참조 등 각종 연산 수행해야 함
 *  (불편)
 *  - 포인터를 즐겨 사용할 필요 없음
 *  - 임베디드 프로그래밍 할 대 메모리에 직접 전근하는 경우 또는 동적 할당 메모리를 사용하는 경우에는 포인터가 반드시 필요함
*/
 ...
 *   값을 전달하면 값이 copy돼서 전달되기 때문에 공유 불가
*/
